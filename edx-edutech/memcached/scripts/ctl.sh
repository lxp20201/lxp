...
# Memcached Control Script

export MEMCACHED_INSTALLDIR=/home/css/edx-edutech/memcached
export MEMCACHED_PORT=11211
export INSTALLDIR=/home/css/edx-edutech
MEMCACHED_PIDFILE="$MEMCACHED_INSTALLDIR/tmp/memcached.pid"
MEMCACHED_PID=""
MEMCACHED_START="$MEMCACHED_INSTALLDIR/bin/memcached -l 127.0.0.1 -p $MEMCACHED_PORT -P $MEMCACHED_PIDFILE -u memcached -d "
MEMCACHED_STATUS=""
