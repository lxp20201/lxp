...
_magic_number = 10
_modified_time = 1580211856.359878
_enable_loop = True
_template_filename = u'/home/css/edx-edutech/apps/edx/edx-platform/lms/templates/preview_menu.html'
...
def render_body(context,active_page=None,**pageargs):
    ...
    try:
        ...
        if show_preview_menu:
            ...
            __M_locals_builtin_stored = __M_locals_builtin()
            __M_locals.update(__M_dict_builtin([(__M_key, __M_locals_builtin_stored[__M_key]) for __M_key in ['masquerade_user_name','selected','specific_student_selected','course_partitions','staff_selected','masquerade_user_partition_id','masquerade_group_id','student_selected'] if __M_key in __M_locals_builtin_stored]))
            ...
            if course_partitions:
                for course_partition in course_partitions:
                    for group in sorted(course_partition.groups, key=lambda group: group.name):
                        ...
                        __M_writer(u'" ')
                        __M_writer(filters.html_escape(filters.decode.utf8(selected(masquerade_user_partition_id == course_partition.id and masquerade_group_id == group.id))))
                        __M_writer(u'>\n                                        ')
...
"""
__M_BEGIN_METADATA
{"source_encoding": "utf-8", "line_map": {"128": 79, "132": 80, "133": 81, "134": 81, "139": 80, "142": 82, "16": 5, "148": 142, "31": 4, "34": 3, "46": 2, "47": 3, "48": 4, "49": 11, "50": 13, "56": 15, "57": 17, "58": 18, "59": 18, "74": 29, "75": 30, "76": 30, "77": 35, "78": 35, "79": 37, "80": 37, "81": 37, "82": 37, "83": 38, "84": 38, "85": 38, "86": 38, "87": 39, "88": 39, "89": 39, "90": 39, "91": 40, "92": 41, "93": 42, "94": 43, "95": 43, "96": 43, "97": 43, "98": 43, "99": 43, "100": 43, "101": 44, "102": 44, "103": 49, "104": 51, "105": 51, "106": 54, "107": 54, "108": 58, "109": 59, "110": 61, "115": 65, "116": 69, "117": 72}, "uri": "/preview_menu.html", "filename": "/home/css/edx-edutech/apps/edx/edx-platform/lms/templates/preview_menu.html"}
__M_END_METADATA
"""
