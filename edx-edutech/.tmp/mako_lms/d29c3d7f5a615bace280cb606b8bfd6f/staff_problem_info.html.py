...
_magic_number = 10
_modified_time = 1580284727.519937
_enable_loop = True
_template_filename = u'/home/css/edx-edutech/apps/edx/edx-platform/lms/templates/staff_problem_info.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        if 'detached' not in tags:
            ...
            if not disable_staff_debug_info:
                ...
                __M_writer(filters.decode.utf8(element_id))
                __M_writer(u'_debug" rel="leanModal" id="')
                __M_writer(filters.decode.utf8(element_id))
                __M_writer(u'_trig">')
    ...
    location.block_type == 'problem':
                    ...
                    __M_writer(filters.decode.utf8(element_id))
                    __M_writer(u'_history" rel="leanModal" id="')
                    __M_writer(filters.decode.utf8(element_id))
