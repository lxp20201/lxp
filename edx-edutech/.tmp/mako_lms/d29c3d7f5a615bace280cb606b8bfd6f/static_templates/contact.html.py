...
_magic_number = 10
_modified_time = 1580284659.716175
_enable_loop = True
_template_filename = u'/home/css/edx-edutech/apps/edx/edx-platform/lms/templates/static_templates/contact.html'
_template_uri = 'static_templates/contact.html'
...
def render_pageheader(context,**pageargs):
    ...
    try:
        ...
        __M_writer = context.writer()
        __M_writer(filters.html_escape(filters.decode.utf8(page_header or _("Contact"))))
        return ''
    finally:
        context.caller_stack._pop_frame()
...
"""
__M_BEGIN_METADATA
{"source_encoding": "utf-8", "line_map": {"65": 5, "97": 13, "71": 5, "103": 97, "42": 1, "43": 2, "44": 3, "77": 10, "16": 2, "49": 5, "84": 10, "54": 10, "90": 13, "59": 13, "29": 1}, "uri": "static_templates/contact.html", "filename": "/home/css/edx-edutech/apps/edx/edx-platform/lms/templates/static_templates/contact.html"}
__M_END_METADATA
"""
