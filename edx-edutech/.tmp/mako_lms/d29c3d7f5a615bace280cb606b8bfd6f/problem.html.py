...
_magic_number = 10
_modified_time = 1580297576.78069
_enable_loop = True
_template_filename = u'/home/css/edx-edutech/apps/edx/edx-platform/lms/templates/problem.html'
...
def render_body(context,**pageargs):
    ...
    try:
      ...
      is_hidden=not has_saved_answers)
        ...
        __M_locals.update(__M_dict_builtin([(__M_key, __M_locals_builtin_stored[__M_key]) for __M_key in ['notification_message'] if __M_key in __M_locals_builtin_stored]))
        __M_writer(u'\n    ')
        runtime._include_file(context, u'problem_notifications.html', _template_uri, 
      notification_type='general',
      notification_icon='fa-info-circle',
