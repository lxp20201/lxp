...
def _mako_generate_namespaces(context):
    ...
    ns = runtime.TemplateNamespace('__anon_0x7f8e488f1a50', context._clean_inheritance_tokens(), templateuri=u'../main.html', callables=None,  calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f8e488f1a50')] = ns
...
def render_body(context,online_help_token,use_cookie_banner=False,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f8e488f1a50')._populate(_import_ns, [u'login_query'])
